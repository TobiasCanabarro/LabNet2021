...
namespace ABM
{
    class Program
    {
        ...
        static void InsertProd()
        {
            ...
            Products product = ProductFactory.Create(78, "French Fries", 2, 1, "20 bags x 4 pieces", 55, 100, 0, 0 , false);
        ...
        static void UpdateProd()
        {
            ...
            Products product = ProductFactory.Create(78, "French Fries", 2, 1, "20 bags x 4 pieces", 55, 0, 0, 0, true);
            ProductLogic logic = new ProductLogic();
